...
export const Item = ({
  ...
  return (
    <div
      ...
      className={cn(
        "group min-h-[27px] text-sm py-1 pr-3 w-full hover:bg-slate-900 flex items-center text-white font-medium",
    ...
    >
      ...
      {documentIcon ? (
        ...
        <Icon className="shrink-0 w-[18px] h-[18px] mr-2 text-white" />
      )}
